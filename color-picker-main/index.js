...
picker.style.padding = "35px 0";
picker.style.backgroundColor = "#c8e6c9";
picker.style.justifyContent = "center"; 


pickerBtn.style.marginRight = "8px";


exportBtn.style.border = "none";
exportBtn.style.outline = "none";
exportBtn.style.color = "#fff";
exportBtn.style.fontSize = "1rem";
exportBtn.style.cursor = "pointer";
exportBtn.style.padding = "6px 12px";
exportBtn.style.backgroundColor = "#43a047";
...
colorval.style.display = "flex";
colorval.style.alignItems = "center";
colorval.style.marginBottom = "5px";

const popupCol = document.querySelector('.color-popup-content');
popupCol.style.padding = "20px";
