...
function backspace_remove(){
    ...
    elements.style.backgroundColor = "#e68a00";
...
const calculates = document.querySelector('#calculator');
calculates.style.width = "350px";
calculates.style.height = "auto";
calculates.style.padding = "1.5vh 3vh";
calculates.style.border = "5px solid #666666";
calculates.style.borderRadius = "15px";
calculates.style.margin = "0";

const boxs = document.querySelector('.box');
boxs.style.textAlign = "right";
boxs.style.padding = "10px";
boxs.style.fontSize = "38px";
boxs.style.border = "2px solid #e68a00";
boxs.style.color = "#fff";
boxs.style.borderRadius = "15px";

const lastOperation = document.querySelector('#last_operation_history');
lastOperation.style.height = "1.8vh";
lastOperation.style.fontSize = "1.8vh";
lastOperation.style.textAlign = "right";
lastOperation.style.paddingRight = "1.5vh";
lastOperation.style.color = "rgb(177, 176, 176)";   
lastOperation.style.backgroundColor = "#000";


const btns = document.querySelectorAll('button');
btns.style.width = "9vh";
btns.style.height = "9vh";
btns.style.fontWeight = "bold";
btns.style.fontSize = "3vh";
btns.style.color = "#fff";
btns.style.backgroundColor = "#666666";
btns.style.borderRadius = "50%";
btns.style.marginRight  = "12px";

const backspaceBtn = document.querySelector('#backspace_btn');
backspaceBtn.style.backgroundSize = "1.7em";
backspaceBtn.style.backgroundPosition = "50% 50%";
backspaceBtn.style.backgroundRepeat = "no-repeat";